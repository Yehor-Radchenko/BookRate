...
{
    public class ContributorValidator : AbstractValidator<BaseContributorDTO>
    {
        public ContributorValidator()
        {
            ...
            RuleFor(x => x.BirthPlace)
                ...
                .Matches(@"^[A-Za-zА-Яа-яЁёЇїІіЄєҐґ\s]*$")
                .WithMessage("Birth place must contain only letters (Latin or Cyrillic) and spaces if provided.")
